...
const { processConversation } = require('./manager-ai/manager-ai-worker.mjs'); // Ensure extension is handled or written purely explicitly
...
async function rawDebug() {
    ...
    if (conv) {
        ...
        try {
            ...
            const worker = await import('./manager-ai/manager-ai-worker.mjs');
